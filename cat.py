...
TOKEN = '7228156373:AAFDm6MYwlZV0x6CatPJAgRegfl0peR9ycU'
MONGO_URI = 'mongodb+srv://shahanshakhan19:password@1234@cluster0.2zacd.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'
FORWARD_CHANNEL_ID = -1002173126497
CHANNEL_ID = -1002173126497
error_channel_id = -1002173126497
...
def send_welcome(message):
    ...
    # Create buttons
    btn1 = KeyboardButton("1-Day Plan 1️⃣")
    btn2 = KeyboardButton("Weekly Plan 7️⃣")
    btn3 = KeyboardButton("Permanent Plan💱")
    btn4 = KeyboardButton("My Account📑")
    btn5 = KeyboardButton("Bgmi Command 👇")
...
def handle_message(message):
    if message.text == "1-Day Plan 1️⃣":
        bot.reply_to(message, "*Single Day Plan= 150,Rs only✅*", parse_mode='Markdown')
    elif message.text == "Weekly Plan 7️⃣":
        bot.reply_to(message, "*Weekly Plan 500 rs✅*", parse_mode='Markdown')
        attack_command(message)
    elif message.text == "Permanent Plan💱":
        bot.send_message(message.chat.id, "*Permanent 1200 Rs only ✅*", parse_mode='Markdown')
    ...
    elif message.text == "Bgmi Command 👇":
        bot.reply_to(message, "*Use /Attack (or check profile pic👆)*", parse_mode='Markdown')
    elif message.text == "Contact Admin⚠️":
        bot.reply_to(message, "*Main Adminstrator @Python_bgmi*", parse_mode='Markdown')
    else:
